...
const serviceLinks = [
  { label: "Fertility", href: "/services/fertility-acupuncture-jacksonville-fl-aborm-certified-dr-julee-miller/" },
  { label: "Pelvic Floor", href: "/pelvic-floor/" },
  { label: "Acupuncture", href: "/services/acupuncture/" },
  { label: "Chronic Pain", href: "/chronic-pain/" },
  { label: "Neurological", href: "/neurological-disorders/" },
  { label: "Sports", href: "/services/sports-acupuncture/" },
  { label: "Pediatric", href: "/services/pediatric-acupuncture/" },
  { label: "Massage", href: "/services/massage-therapy-jacksonville/" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="text-gray-400 hover:text-primary transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary rounded-sm"
              >
              ...
              <a
                href="https://www.youtube.com/@HealthPointeJax"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Health Pointe Jacksonville on YouTube"
                className="text-gray-400 hover:text-primary transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary rounded-sm"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <nav aria-label="Services footer navigation">
            <h3 className="text-sm font-bold uppercase tracking-widest text-primary mb-4">Services</h3>
            <ul className="space-y-2">
              {serviceLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-300 hover:text-primary transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary rounded-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Quick links */}
          <nav aria-label="Quick links footer navigation">
            <h3 className="text-sm font-bold uppercase tracking-widest text-primary mb-4">Quick Links</h3>
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-sm font-bold uppercase tracking-widest text-primary mb-4">Stay Connected</h3>
            <p className="text-sm text-gray-300 mb-4">
              Wellness tips, clinic updates, and seasonal health insights — delivered to your inbox.
            </p>
            <NewsletterForm />
          </div>
        </div>
