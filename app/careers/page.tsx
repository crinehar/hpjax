...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hpjax.com/careers" },
  openGraph: {
    title: "Careers at Health Pointe Jacksonville | Join Our Team",
    description:
      "Explore current opportunities at Health Pointe Jacksonville in Jacksonville. See open roles, clinic culture, and how to apply.",
...
const openings = [
  ...
  },
  {
    ...
    slug: "licensed-massage-therapist",
    status: "filled",
    description:
              ...
              <ScrollReveal key={job.title} delay={i * 0.08}>
                <div className={`rounded-2xl p-8 border ${job.status === "open" ? "bg-white border-surface-muted shadow-sm" : "bg-surface border-surface-muted opacity-60"}`}>
                  ...
                  <div className="mt-5 flex flex-wrap gap-4">
                    {job.status === "open" && (
                      <a
                        href="mailto:careers@hpjax.com?subject=Career%20Inquiry"
                        className="inline-flex items-center gap-1 text-teal-dark font-semibold text-sm underline underline-offset-2 hover:text-teal transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-dark rounded"
                      >
                        Apply via email →
                      </a>
                    )}
                    <Link
                      ...
                      className="inline-flex items-center gap-1 text-ink-muted font-semibold text-sm underline underline-offset-2 hover:text-teal-dark transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-dark rounded"
                    >
